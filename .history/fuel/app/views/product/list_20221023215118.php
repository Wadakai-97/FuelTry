...
<?php echo Asset::img('character/onepiece01_luffy2.png', array('width' => '120', 'height' => '120', 'alt' => 'ルフィ')); ?>
    ...
    <?= Form::open(array('action'=>'product/search', 'class'=>'form-inline text-center center-block')) ?>
      <div class=”form-row“>
        ...
        <div class="form-group col-auto">
          ...
          <?php echo '<select name="company_id[]" class="form-control" id="txt-search" multiple><option value="" selected>未選択</option>'?>
          <?php 
