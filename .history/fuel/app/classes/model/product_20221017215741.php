...
class Model_Product extends \Orm\Model
{
	...
	*/
	public static function getList($pagination) {
		$products = DB::select('products.id', 'name', 'price', 'company_id', 'companies' 'company_name')
									->from('products')
	...
	*/
	public static function getAll() {
		$products = DB::select('products.id', 'name', 'price', 'company_id', 'companies.id', 'company_name')
									->from('products')
									->join('companies', 'INNER')
									->on('products.company_id', '=', 'companies.id')
									->execute()
