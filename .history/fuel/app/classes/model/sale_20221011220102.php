...
class Model_Sale extends \Orm\Model
{
	...
	public static function getData() {
		...
		// switch($type) {
		// 	case year:
				$datas = DB::select(DB::expr("date_format('created_at', '%Y-%m') as 'year', count('created_at') as count"),
														DB::expr("date_format('created_at', '%Y-%m') as 'year', sum('discount') as discount"), 
														DB::expr("date_format('created_at', '%Y-%m') as 'year', sum('sale') as sale"))
										->from('sales')
										->execute()
										->as_array();
			// case monthly:
